...
Subscribe to their `status pages <https://status.box.com/>`__. Look for other tools that may help you in a pinch 
like `GoToWebinar's system check <https://support.goto.com/webinar/system-check-attendee>`__ to help someone figure out what's wrong 
...
I did in `this post I wrote focused on tools for writers <https://lofipython.com/python-libraries-tools-resources-for-creative-and-academic-writers/>`__!
